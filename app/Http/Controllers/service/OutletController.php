...
class OutletController extends Controller
{
    public function index()
    {
        ...
        $outlets = CompanyMaster::where('website_id',$company_now->id)->get();
        $outlets1 = CompanyMaster::where('website_id',$company_now->id)->get();
        return view('service.outlet', compact('outlets1','banks','categories','orders','company_now','outlets','companies'));
    }
