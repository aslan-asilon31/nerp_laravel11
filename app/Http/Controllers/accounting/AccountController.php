...
use App\Models\MasterData\AccountMaster;
...
class AccountController extends Controller
{
    public function index()
    {
        ...
        $account_counts = AccountMaster::orderBy('code', 'asc');
        $accounts = AccountMaster::orderBy('code', 'asc')
                ->paginate(20);
                
        return view('accounting.account', compact('categories','account_counts','companies','outlets','orders','accounts','company_now','workspace'));
    }
