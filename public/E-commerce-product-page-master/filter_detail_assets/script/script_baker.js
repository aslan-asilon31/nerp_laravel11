	...
	switch(alt){
		case "image_1":
				for(let i=0;i<image_preview.length;i++){
					image_preview[i].src = "./filter_detail_assets/images/wedding_1.png";
		...
		case "image_2":
				for(let i=0;i<image_preview.length;i++){
					image_preview[i].src = "./filter_detail_assets/images/wedding_2.png";
		...
		case "image_3":
				for(let i=0;i<image_preview.length;i++){
					image_preview[i].src = "./filter_detail_assets/images/wedding_3.png";
		...
		case "image_4":
				for(let i=0;i<image_preview.length;i++){
					image_preview[i].src = "./filter_detail_assets/images/wedding_4.png";
		...
		case "image_5":
				for(let i=0;i<image_preview.length;i++){
					image_preview[i].src = "./filter_detail_assets/images/wedding_5.png";
					image_preview[i].alt = "image_5";

				}
				for(let i=0;i<images1.length;i++){
					if(images1[i].alt == "image_5"){
						images1[i].className = "active";
						images2[i].className = "active";
					}else{
						images1[i].classList.remove("active");
		...
		case "image_6":
				for(let i=0;i<image_preview.length;i++){
					image_preview[i].src = "./filter_detail_assets/images/wedding_6.png";
					image_preview[i].alt = "image_6";

				}
				for(let i=0;i<images1.length;i++){
					if(images1[i].alt == "image_6"){
						images1[i].className = "active";
						images2[i].className = "active";
					}else{
						images1[i].classList.remove("active");
		...
		case "image_7":
				for(let i=0;i<image_preview.length;i++){
					image_preview[i].src = "./filter_detail_assets/images/wedding_7.png";
					image_preview[i].alt = "image_7";

				}
				for(let i=0;i<images1.length;i++){
					if(images1[i].alt == "image_7"){
						images1[i].className = "active";
						images2[i].className = "active";
					}else{
						images1[i].classList.remove("active");
		...
		case "image_8":
				for(let i=0;i<image_preview.length;i++){
					image_preview[i].src = "./filter_detail_assets/images/wedding_8.png";
					image_preview[i].alt = "image_8";

				}
				for(let i=0;i<images1.length;i++){
					if(images1[i].alt == "image_8"){
						images1[i].className = "active";
						images2[i].className = "active";
					}else{
						images1[i].classList.remove("active");
