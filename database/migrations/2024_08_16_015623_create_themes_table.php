...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('themes', function (Blueprint $table) {
            ...
            $table->string('font_color')->nullable(); // Deskripsi tema (opsional)
            $table->string('active_color')->nullable(); // Deskripsi tema (opsional)
            $table->string('type')->nullable(); // Deskripsi tema (opsional)
