...
@section('content')
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h1>@yield('title') List {{$account_counts->count()}} data<i class="far fa-star"></i> </h1>
          </div>
                      ...
                      <tbody>
                        @forelse($accounts as $account)
                          <tr id="tampil-menu">
                              ...
                              <td>{{$account->entry}}</td>
                              <td>
                                  <a href="javascript:void(0)" class="btn btn-warning btn-sm text-white"><i
                                          class="fa fa-edit"></i></a>
                                  <a href="javascript:void(0)" class="btn bg-purple btn-sm"><i
