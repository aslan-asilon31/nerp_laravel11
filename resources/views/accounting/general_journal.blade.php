...
@section('content')
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h1>@yield('title') List {{$general_journal_counts->count()}} data<i class="far fa-star"></i> </h1>
          </div>
          ...
          <div class="row">
              ...
              <div class="card-body" id="card-table" style="overflow-x: auto; overflow-y: auto; max-height: 1000px;">
                  <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        @forelse($general_journals as $general_journal)
                          <tr id="tampil-menu">
                              <td>{{$general_journal->date}}</td>
                              <td>{{$general_journal->description}}</td>
                              <td>{{$general_journal->account_name}}</td>
                              <td>{{$general_journal->debit}}</td>
                              <td>{{$general_journal->credit}}</td>
                          </tr>
