...
@section('content')
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h1>@yield('title') List {{ $trial_balance_counts->count()}} data<i class="far fa-star"></i> </h1>
          </div>
    ...
    <section class="content pb-3 " style="height:1200px;">
      ...
      <div class="bg-white p-2"style="overflow-x: auto; overflow-y: auto; max-height: 1100px;">
          ...
          <div class="row">
              ...
              @foreach ($trial_balance_members as $glm)
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Jumlah</td>
                            <td>
                                Rp {{ number_format($trial_balances->where('group_code', $glm->group_code)->sum('debit'), 2) }}
                            </td>
                            <td>
                                Rp {{ number_format($trial_balances->where('group_code', $glm->group_code)->sum('credit'), 2) }}
                            </td>
                        </tr>
                    </tbody>
                </table>
