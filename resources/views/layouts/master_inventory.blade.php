...
<div class="wrapper">
  ...
  <aside class="main-sidebar  elevation-4 mb-5" style="background-color:indigo;color:white !important;font-weight:bolder;">
    <!-- Brand Logo -->
    ...
    <div class="sidebar">
      ...
      <select id="" class="form-control  " style="width: 100%;" >
        @forelse($outlets as $outlet)
          <option value="{{ $outlet->id }}" style="padding-top:0px;margin-bottom:5px;"> {{$company_now->name}} - Outlet {{ $outlet->name }} </option>
          @empty
          <option value="">-</option>
        @endforelse
      </select>
      ...
      <nav class="mt-2" style="overflow-x: auto;overflow-y: auto;">
        <ul class="nav nav-pills nav-sidebar flex-column " data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="../../../attributes/product_attributes.html" class="nav-link text-white " id="inventory-product-list">
              <i class="fa fa-shopping-cart nav-icon"></i>
              <p>Products</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="product_reviews.html" class="nav-link text-white" id="inventory-product-combo">
              <i class="fa fa-cubes nav-icon"></i>
              <p>Product Combos</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="product_reviews.html" class="nav-link text-white" id="inventory-product-price">
              <i class="fa fa-dollar-sign nav-icon"></i>
              <p>Product Prices </p>
            </a>
          </li>
          <li class="nav-item">
            <a href="../../../attributes/product_attributes.html" class="nav-link text-white" id="inventory-supplier">
              <i class="fa fa-users  nav-icon"></i>
              <p>Suppliers</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="../../../attributes/product_attributes.html" class="nav-link text-white" id="inventory-purchase">
              <i class="fa fa-shopping-cart nav-icon"></i>
              <p>Purchases</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="products.html" class="nav-link text-white" id="inventory-ingredient-recipe">
              <i class="fa fa-book nav-icon"></i>
              <p>Ingredient Recipe</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="products.html" class="nav-link text-white" id="inventory-menu-book">
              <i class="fa fa-book nav-icon"></i>
              <p>Menu Book</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="manufactures.html" class="nav-link text-white" id="inventory-category">
          ...
          <li class="nav-item">
            <a href="product_reviews.html" class="nav-link text-white" id="inventory-service-product">
              <i class="fa fa-concierge-bell nav-icon"></i>
              <p>Service Product</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="product_reviews.html" class="nav-link text-white" id="inventory-extra-product">
              <i class="fa fa-plus-square nav-icon"></i>
              <p>Extra Product</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="product_reviews.html" class="nav-link text-white" id="inventory-product-bundling">
              <i class="fa fa-box-open nav-icon"></i>
              <p>Product Bundling</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="product_reviews.html" class="nav-link text-white" id="inventory-deposit">
              <i class="fa fa-coins  nav-icon"></i>
              <p>Deposit</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="product_reviews.html" class="nav-link text-white" id="inventory-online-vehicle">
              <i class="fa fa-motorcycle  nav-icon"></i>
              <p>Online Vehicle Price List</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="product_reviews.html" class="nav-link text-white" id="inventory-print-barcode">
