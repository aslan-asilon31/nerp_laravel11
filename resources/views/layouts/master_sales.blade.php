        ...
        <ul class="nav nav-pills nav-sidebar flex-column " data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview ml-3">
              <li class="nav-item">
                <a href="./customers/customer-list.html" class="nav-link text-white">
              ...
              <li class="nav-item">
                <a href="../../../manufactures.html" class="nav-link text-white">
                  ...
                  <p>Special Price Group</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../../../product_reviews.html" class="nav-link text-white">
                  <i class="fa fa-user-edit nav-icon"></i>
                  <p>Custom data Customer</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../../../customers/customer_roles.html" class="nav-link text-white">
                  <i class="fa fa-user-lock nav-icon"></i>
                  <p>Customer Roles</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../../../customers/online_customers.html" class="nav-link text-white">
                  <i class="fa fa-user-check nav-icon"></i>
                  <p>Online Customers</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../../../customers/vendores.html" class="nav-link text-white">
                  <i class="fa fa-truck nav-icon"></i>
                  <p>Vendors</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../../../customers/activity_log.html" class="nav-link text-white">
                  <i class="fa fa-history nav-icon"></i>
                  <p>Activity Log</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../../../customers/activity_type.html" class="nav-link text-white">
                  <i class="fa fa-tasks nav-icon"></i>
                  <p>Activity Type</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../../../customers/gdpr_request_log.html" class="nav-link text-white">
