...
<head>
  ...
  <!-- 
    - favicon
  -->
  <link rel="shortcut icon" href="{{ asset('volti_htmlcss/favicon.svg') }}" type="image/svg+xml">

  <!-- 
    - custom css link
  -->
  <link rel="stylesheet" href="{{ asset('volti_htmlcss/assets/css/style.css') }}">

  <!-- 
    - custom font link
  -->
  <link rel="stylesheet" href="{{ asset('volti_htmlcss/assets/font/font.css') }}">

  <!-- 
    - preload images
  -->
  <link rel="preload" as="image" href="{{ asset('volti_htmlcss/assets/images/loading.svg') }}">
  <link rel="preload" as="image" href="{{ asset('volti_htmlcss/assets/images/loading-circle.svg') }}">
  <link rel="preload" as="image" href="{{ asset('volti_htmlcss/assets/images/hero-banner.png') }}">
...
<body id="top">
  ...
  <div class=" preload-box" data-preloader>
    <img src="{{ asset('volti_htmlcss/assets/images/loading.svg') }}" width="45" height="45" alt="loading">

    <img src="{{ asset('volti_htmlcss/assets/images/loading-circle.svg') }}" width="75" height="75" alt="loading" class="preload-circle">
  </div>
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo">
        <img src="{{ asset('volti_htmlcss/assets/images/logo.svg') }}" width="160" height="50" alt="volti home">
      </a>
  ...
  <footer class="footer">
    <div class="container">
      ...
      <div class="footer-bottom">
        ...
        <img src="{{ asset('volti_htmlcss/assets/images/footer-logo.svg') }}" width="100" height="63" loading="lazy" alt="Volti home">
  ...
  <!-- 
    - custom js link
  -->
  <script src="{{ asset('volti_htmlcss/assets/js/script.js') }}"></script>
