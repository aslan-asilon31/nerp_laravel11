...
<head>
   ...
   <!--=============== FAVICON ===============-->
   <link rel="shortcut icon" href="{{ asset('lumina_htmlcss/img/favicon.png') }}" type="image/x-icon">

   <!--=============== REMIXICONS ===============-->
   <link href="https://cdn.jsdelivr.net/npm/remixicon@3.2.0/fonts/remixicon.css" rel="stylesheet">

   <!--=============== SWIPER CSS ===============-->
   <link rel="stylesheet" href="{{ asset('lumina_htmlcss/assets/css/swiper-bundle.min.css') }}">

   <!--=============== CSS ===============-->
   <link rel="stylesheet" href="{{ asset('lumina_htmlcss/assets/css/styles.css') }}">>
...
<body>
               ...
               <li class="nav__item after_login nav__link" id="nav-profile" >
                  <div class="profile">
                        ...
                        <div class="img-box show-menu ">
                           ...
                           @else
                              <img src="{{ asset('lumina_htmlcss/assets/img/man4.png')}}" class="rounded">
                           @endif
                        </div>
                  </div>
                  <div class="menu">
         ...
         <div class="home__container container grid">
            ...
            <div class="home__image">
               <div class="home__blob">
                  <img class=" animate__animated infinite-swing " src="{{asset('lumina_htmlcss/img/home-lamp.png')}}" alt="home image" class="home__img">
               ...
               <div class="swiper-wrapper">
                  <article class="popular__card swiper-slide">
                     <div class="popular__blob">
                        <img src="{{ asset('lumina_htmlcss/assets/img/modern-lamp.png') }}" alt="popular image" class="popular__img">
                     </div>
                  ...
                  <article class="popular__card swiper-slide">
                     <div class="popular__blob">
                        <img src="{{ asset('lumina_htmlcss/assets/img/industrial-lamp.png') }}" alt="popular image" class="popular__img">
                     </div>
                  ...
                  <article class="popular__card swiper-slide">
                     <div class="popular__blob">
                        <img src="{{ asset('lumina_htmlcss/assets/img/superbolw-lamp.png') }}" alt="popular image" class="popular__img">
                     </div>
                  ...
                  <article class="popular__card swiper-slide">
                     <div class="popular__blob">
                        <img src="{{ asset('lumina_htmlcss/assets/img/ultrawide-lamp.png') }}" alt="popular image" class="popular__img">
                     </div>
                  ...
                  <article class="popular__card swiper-slide">
                     <div class="popular__blob">
                        <img src="{{ asset('lumina_htmlcss/assets/img/roundness-light.png') }}" alt="popular image" class="popular__img">
                     </div>
         ...
         <div class="choose__container container grid">
            <div class="choose__image">
               <div class="choose__blob">
                  <img src="{{ asset('lumina_htmlcss/assets/img/choose-lamp.png') }}" alt="choose image" class="choose__img">
         ...
         <div class="features__container container grid">
            <div class="features__image">
               <div class="features__blob">
                  <img src="{{ asset('lumina_htmlcss/assets/img/features-lamp.png') }}" alt="features image" class="features__img">
            ...
            <div class="products__content grid">
               <article class="products__card">
                  <div class="products__blob">
                     <img src="{{ asset('lumina_htmlcss/assets/img/modern-lamp.png') }}" alt="products image" class="products__img">
                  </div>
               ...
               <article class="products__card">
                  <div class="products__blob">
                     <img src="{{ asset('lumina_htmlcss/assets/img/industrial-lamp.png') }}" alt="products image" class="products__img">
                  </div>
               ...
               <article class="products__card">
                  <div class="products__blob">
                     <img src="{{ asset('lumina_htmlcss/assets/img/superbolw-lamp.png') }}" alt="products image" class="products__img">
                  </div>
               ...
               <article class="products__card">
                  <div class="products__blob">
                     <img src="{{ asset('lumina_htmlcss/assets/img/ultrawide-lamp.png') }}" alt="products image" class="products__img">
                  </div>
               ...
               <article class="products__card">
                  <div class="products__blob">
                     <img src="{{ asset('lumina_htmlcss/assets/img/roundness-light.png') }}" alt="products image" class="products__img">
                  </div>
               ...
               <article class="products__card">
                  <div class="products__blob">
                     <img src="{{ asset('lumina_htmlcss/assets/img/stickness-light.png') }}" alt="products image" class="products__img">
                  </div>
               ...
               <article class="products__card">
                  <div class="products__blob">
                     <img src="{{ asset('lumina_htmlcss/assets/img/superjet-light.png') }}" alt="products image" class="products__img">
                  </div>
               ...
               <article class="products__card">
                  <div class="products__blob">
                     <img src="{{ asset('lumina_htmlcss/assets/img/nakedness-lamp.png') }}" alt="products image" class="products__img">
                  </div>
            ...
            <div class="join__bg grid">
               <div class="join__image">
                  <div class="join__blob">
                     <img src="{{ asset('lumina_htmlcss/assets/img/join-lamp.png') }}" alt="join image" class="join__img">
   ...
   <!--=============== SCROLLREVEAL ===============-->
   <script src="{{ asset('lumina_htmlcss/assets/js/scrollreveal.min.js') }}"></script>

   <!--=============== SWIPER JS ===============-->
   <script src="{{ asset('lumina_htmlcss/assets/js/swiper-bundle.min.js') }}"></script>

   <!--=============== MAIN JS ===============-->
   <script src="{{ asset('lumina_htmlcss/assets/js/main.js') }}"></script>
